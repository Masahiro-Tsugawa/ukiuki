package com.internousdev.ukiukiutopia.Token;
...
public class TwitterRequestToken {
	...
	* コンシューマーキー
	*/
	final String CONSUMER_KEY = "MYDN5Qnhhl6kYjC04EX885kOq";

	/**
	* コンシューマーシークレット
	*/
	final String CONSUMER_SECRET = "nxLmFYKXO4OiLJIYeLCzWWYFCdHvZLPcs6SreSLaFNQZ38x7eR";
