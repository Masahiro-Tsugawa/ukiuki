...
public class PersonalPostalDAO {
...
//アップデートするメソッド
	public int update(int updateid, String updatepostal)throws Exception{
		System.out.println("update - メソッド実行");
		con = DBConnector.getConnection();
		int rscount=0;
		try{
		String sql = "update user set postal=? where id=?";

		PreparedStatement ps2;

		ps2=con.prepareStatement(sql);
		ps2.setString(1, updatepostal);
